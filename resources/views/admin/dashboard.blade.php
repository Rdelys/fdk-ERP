...
@section('content')
    ...
    <div class="dashboard-welcome">
        <div>
            ...
            <p><i class="fas fa-calendar-alt"></i> Gestion des projets et prospects en temps réel</p>
        </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-change">
                <i class="fas fa-arrow-up up"></i> Actifs
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-change">
                <i class="fas fa-user-check"></i> En activité
            </div>
        </div>
